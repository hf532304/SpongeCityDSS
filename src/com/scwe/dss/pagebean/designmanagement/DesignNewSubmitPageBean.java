...
public class DesignNewSubmitPageBean extends MyThankYouPageBean{

  /**
	 * 
	 */
	private static final long serialVersionUID = -5204335278175469799L;

  public static String PageBeanName = "com.scwe.dss.pagebean.designmanagement.DesignNewSubmitPageBean"; 
  ...
  public DesignNewSubmitPageBean(){
	super();
  ...
  protected void doBeforeRun(Properties myProperty, HttpServletRequest request) {
	...
	if (StringHelper.isEmpty(msgDisplay)){
		msgDisplay = "<div align='center'>新增设计方案信息已经成功加入到数据库中！</div>";
	} else {
