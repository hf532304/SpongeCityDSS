  ...
  <script>
	  var visible = [];
		var sRunoffLayout = [[{'name': '汇水区', 'field': 'subcatchmentId', 'width': '100px'},
	      ...
	      {'name': '目标年径流总控制率', 'field': 'tRateARV', 'width': '120px'}
		]];	  
		var myMap;	  
    var xStr;
    var xRain;    
    ...
    var IsSRunoffTabStarted = false;
    var IsRainDataTabStarted = false;
