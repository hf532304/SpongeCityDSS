...
<%@page import="com.jl.foundation.util.StringHelper"%>
    ...
    require([
      ...
      ready(function(){
        ...
        myMap.on("load",function () {
         	...
         	<%if (StringHelper.isEmpty(pageBean.getPageErrMsg()) ){ %>
          	dom.byId("MsgDiv").innerHTML = "<%=pageBean.getMyInfoStr()%>";
          <%} else {%>
	          dom.byId("MsgDiv").innerHTML = "<hr/><%=pageBean.getPageErrMsg()%><br/><hr/>";
          <%}%>
        });        
      })  
