...
<form name="Form1" id="Form1" action="Page" method="post">
		...
		<table board="1">
			...
			<tr><td colspan=2><img src="images/clear.gif" width="1" height="20" border="0" alt=""></td></tr>			
			<tr><td>INP文件：</td><td><input name="INPDisplayOnly" type="text" value="<%=pageBean.getSelectedData().inpFileName%>" readonly>
							<Button type="Button" onclick="document.getElementById('Name').value='<%=pageBean.getUploadPage()%>';document.getElementById('Form1').submit();">上传新文件</Button></td></tr>
